...
Samples <-c("CR_000_E", "MCF7_chIPseq", "LTED_chIPseq", "Standard_ER_Peaks")

pdf("venn.pdf")
makeVennDiagram(Peaks=list(uniqueMerged, uniqueMcf7, ltedChipseqPeak , carollPeaks), NameOfPeaks=Samples, totalTest = 25000)
dev.off()
```
